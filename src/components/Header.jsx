//rfc: react functional
import React from 'react'

export default function Header(props) { //props: tham số nhận dữ liệu từ component cha truyền vô
    
    // let title = "cybersoft"; //Tạo biến binding lên html
